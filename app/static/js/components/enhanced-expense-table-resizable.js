// app/static/js/components/enhanced-expense-table-resizable.js
const ResizableTable = (props) => {
  // State management for data (same as before)
  ...
  const [columnWidths, setColumnWidths] = React.useState({
    category: 150,
    description: 300,
    // Other columns will be sized automatically
  });
...
if (typeof module !== "undefined" && module.exports) {
  module.exports = { default: ResizableTable };
} else {
  // For direct script tag inclusion
  window.ResizableTable = ResizableTable;
}